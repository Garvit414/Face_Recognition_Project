...
st.sidebar.image('https://brainalyst.in/wp-content/uploads/2022/07/b1.jpg',
                 width=150, use_column_width=False)
st.sidebar.markdown("""
                    > Made by [*BRAINALYST*](https://www.linkedin.com/company/brainalyst/)
                    """)
...
def main():
    ...
    st.sidebar.info("This webapp does Face Detection and Recognition"
                    "")
    ###################################################

    selected_menu = option_menu(None,
        ['Visitor Validation','Face Recognition' ,'View Visitor History', 'Add to Database'],
        icons=['camera',"wecam", "clock-history", 'person-plus'],
    ...
    if selected_menu == 'Face Recognition':
        st.write("Hello") 
